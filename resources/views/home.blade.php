    ...
    <header class="masthead">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Tama Team Sports</div>
                <div class="intro-heading text-uppercase">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quid autem habent admirationis,</div>
            </div>
        </div>
    </header>
