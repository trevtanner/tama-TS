<template>
<div class="container pt-3 header">
    <b-row>
        <b-col>
    <h2>Privacy Policy</h2>
    <p>
        Your privacy is important to us. It is TT Web Development &amp; Design's and Tama Team Sports' policy to respect your
        privacy regarding any information we may collect from you across our website,
        <a href="https://tamateamsports.com">https://tamateamsports.com</a>, and other sites we own and operate.
    </p>
    <p>
